...
grep -Fq 'sudo rm -rf /opt/infra/monitoring/blackbox /opt/infra/monitoring/grafana /opt/infra/monitoring/prometheus /opt/infra/monitoring/scripts' "$WORKFLOW_FILE"
