...
assert_file "${ROOT_DIR}/deploy/host-caddy/sites/pawtogether-prod.caddy"
assert_file "${ROOT_DIR}/deploy/host-caddy/sites/pawtogether-dev.caddy"
assert_file "${ROOT_DIR}/deploy/host-caddy/sites/nooook-monitoring.caddy"
